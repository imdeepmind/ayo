...
export default function UploadStickyBar({ fileCount, onUpload, disabled }: UploadStickyBarProps) {
  ...
  return (
    <div className="fixed bottom-10 left-0 right-0 z-40 border-t border-slate-200 bg-white/80 p-4 backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/80">
