...
export default function Header() {
  ...
  return (
    <header className="w-full shrink-0 bg-surface border-b border-border py-6 px-8 md:px-10">
              ...
              {menuOpen && (
                <>
                  <div
                    ...
                    aria-hidden="true"
                  />
                  <div className="absolute right-0 z-50 mt-3 w-56 overflow-hidden rounded-xl border-2 border-border bg-surface shadow-2xl dark:shadow-black/10 dark:border-border-strong">
