  ...
  return (
    ...
    >
      ...
      <div className="relative inline-flex h-7 w-12 flex-shrink-0">
        ...
        <div className="h-7 w-12 rounded-full border-2 border-border-strong bg-surface-muted transition-all duration-200 peer-checked:border-primary peer-checked:bg-primary peer-focus:ring-4 peer-focus:ring-primary/50 peer-focus:ring-offset-2 peer-focus:ring-offset-white dark:border-border-input dark:bg-surface-muted dark:peer-checked:border-primary dark:peer-checked:bg-primary dark:peer-focus:ring-offset-slate-900 shadow-inner" />
